...
| `Terminal`               | Live tmux pane capture                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `JournalCTL`             | JournalCTL-checker. Checks system logs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `Random_Nonsense`        | Get random useless fact, Chuck Norris joke, a Dad joke (I do not recommend), historical thing that happened today, cat/dog facts (just so there's something for the Facebook segment), quote (yes, Pinterest, as much as we collectively do our best to ignore you, we still acknowledge your existence), onthisday, inspirobot (you're welcome), programmingjoke (making these tools has their perks), insult (yes, it does what it says on the tin), joke (we couldn't decide on which API to use, so we landed on "All of them")  |
...
| `Meals`                  | Same as `Cocktails`, but for meals                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `Pokemon`                | Fetch facts about anything pokemon. It has: pokemon, species, ability, move, type, and random                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `My_Dict`                | Adds a simple dictionary connector for all of your custom dictionary needs. Supports words, quotes, and definitions (now you can finally formalize *your* personal definition of the word "misinformation")                                                                                                                                                                                                                                                                                                                          |
| `Excusor`                | Picks a random excuse for why you can't do X/show up to Y. Has 4 modes: `factual` (Sorry, boss, can't come in today, it's the anniversary of the Jalta conference), `fictional` (Sorry, can't come to tonight's D&D session, I'm celebrating the anniversary of the ring being destroyed), `madeUp` (sorry, I can't that day, I'm attending Luke Skywalker's birthday party), `folklore` (same as `madeUp`, but with a date attached. Also, sorry, can't right now, It's the feast day of Saint Postgres of the Unexpected Migration) |
